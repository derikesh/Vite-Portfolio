...
export default function AboutRedirect() {
    return (
        <>
            <Box  position={'relative'} overflow={'hidden'} my={20} _hover={{ boxShadow: '0px 0px 34px rgba(249.69, 249.69, 249.69, 0.25)', color: 'white' }} transition={'0.3s ease-in'} className="about_redirect" bg={'transparent'} border="3px solid #FFDDBD" color={'#FFDDBD'} borderRadius="10px" p={{md: '46px', sm: '30px', base: '40px 20px'}}>
                <Heading pb={{sm:10,base:5}} fontSize={{md:42, sm:28, base:24}} as={'h2'} >Explore all of my works in detail</Heading>
